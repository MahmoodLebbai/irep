 ...
 */
public class UserDelegationServiceTest extends AbstractDbUnitJpaTests
    implements UserDelegationServiceTestBase {
    @Autowired
    protected UserDelegationService userDelegationService;
