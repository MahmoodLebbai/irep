 ...
 */
public class UserGroupCategoryPermissionServiceTest
    extends AbstractDbUnitJpaTests
    implements UserGroupCategoryPermissionServiceTestBase {
    @Autowired
    protected UserGroupCategoryPermissionService userGroupCategoryPermissionService;
