...
public class UserEmail extends AbstractDomainObject implements Auditable,
    ...
    public UserEmail(String emailId) {
        super();
        Validate.notNull(emailId, "UserEmail.emailId must not be null");
